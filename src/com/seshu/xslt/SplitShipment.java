...
public class SplitShipment
{
    ...
    {
        String inputFile = "C:\\Projects\\BTA\\APIClient\\BTA\\xsltest\\Shipments_2.xml";
        ...
        XPathExpression allProductsExpression = xpath.compile("//PS/ProcessShipment/DataArea/Shipment/ShipmentHeader/DocumentID/ID/text()");
        ...
        {
            String xpathQuery = "/PS/ProcessShipment/DataArea/Shipment/ShipmentHeader/DocumentID/ID='" + supplier + "']";
            ...
            Element root = suppXml.createElement("ProcessShipment"); 
            ...
            StreamResult result =  new StreamResult(new File("C:\\Projects\\BTA\\APIClient\\BTA\\xsltest\\" + supplier.trim() + ".xml"));
